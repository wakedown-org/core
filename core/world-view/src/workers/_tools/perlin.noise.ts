export class Perlin {
  ...
  public static Noise(point: number[], factor = 1, p: number[] = this.DefaultP, persistence = 0.5, octaves = 6) {
    return this.octaves(point[0]/factor, point[1]/factor, (point[2] ?? 1)/factor, p, persistence, octaves);
  }
}